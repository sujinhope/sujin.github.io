...
- **HTTP 방식** : client가 server에서 html을 다운받고 나면 연결을 끊어버림.***(HTTP통신의 특징 - 비연결(stateless))***
  ...
  **특징**
  ...
  - **Request, Response**
    ...
    ![Request_Response](https://user-images.githubusercontent.com/33229855/70770180-c2a07780-1daf-11ea-9170-8b8fad493fbb.png)

  - **Server push X** 

    : 서버에 접근이 불가능함.(?)

    => activeX, silverlight 같은 프로그램들을 이용하여 해결
