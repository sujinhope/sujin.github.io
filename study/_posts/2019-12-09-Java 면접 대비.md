...
- Polymorphism(다형성)
  ...
  ```
   - 장점
     ...
     super 클래스와 sub클래스를 다형성에 의해 super 클래스 타입으로 한꺼번에 관리 및 저장이 가능하다.
...
Heap 영역에 생성된 객체들의 메모리 관리를 담당하는 프로그램이다. 
...
- 자바에서는 다차원 배열이 참조 형식으로 되어있기 때문에 **열의 크기가 고정되지 않아도 된다.**
  ...
  <center> ![자바_다차원 배열.img](https://user-images.githubusercontent.com/33229855/70488572-73064580-1b3c-11ea-827b-0ce9d36baf48.png)</center>
